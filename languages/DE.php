...
/**
 ...
 -----------------------------------------------------------------------------------------
  DEUTSCHE SPRACHDATEI F�R DAS HELLO WORLD MODUL
 -----------------------------------------------------------------------------------------
**/

// sprachabh�ngige Modulbeschreibungen wurden mit WB 2.7 eingefuehrt (default English in info.php)
...
$MOD_HELLOWORLD = array(
	// Variablen f�r Textausgaben im Frontend (view.php)
	...
	// Variablen f�r Textausgaben im Backend (modify.php)
